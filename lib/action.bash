...
init.config ()
{
  ...
  export BOOST_SCANNER_IMAGE=$(config.get "SCANNER_IMAGE")
  export BOOST_SCANNER_VERSION=$(config.get "SCANNER_VERSION")

  export BOOST_EXEC_COMMAND=$(config.get "EXEC_COMMAND")
  export DOCKER_CREATE_ARGS=$(config.get "DOCKER_CREATE_ARGS")

  export BOOST_CLI_ARGUMENTS=$(config.get "ADDITIONAL_ARGS")
  export BOOST_CLI_VERSION=$(config.get "CLI_VERSION" "2.0")
